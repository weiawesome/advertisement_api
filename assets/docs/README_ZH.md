...
[API 文檔內容](api_specification.yaml)
...
![user_platform_distribution.png](../user_platform_distribution.png)
...
![user_device_distribution.png](../user_device_distribution.png)
...
```
### 併發流量測試 - 時段限制
![duration_limit_test.png](../duration_limit_test.png)
```
備註 :
